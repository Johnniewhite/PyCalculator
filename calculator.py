...
txtDisplay = Entry(cal, font=('arial', 20, 'bold'), textvariable=text_Input, bd=8, insertwidth=4, 
...
btnpoint= Button(cal, padx=16,pady= 16, bd=8, fg='black', font=('arial', 20, 'bold'), 
            text='.', bg='powder blue', command= lambda:btnClick(".")) .grid(row=4, column=1)
...
btnopenbracket= Button(cal, padx=16,pady= 16, bd=8, fg='black', font=('arial', 20, 'bold'), 
            text='(',bg='powder blue', command=lambda:btnClick("(")) .grid(row=5, column=1)

btnclosebracket= Button(cal, padx=16, pady= 16,bd=8, fg='black', font=('arial', 20, 'bold'), 
            text=')', bg='powder blue', command= lambda:btnClick(")")) .grid(row=5, column=2)

percent= Button(cal, padx=16, pady= 16, bd=8, fg='black', font=('arial', 20, 'bold'), 
